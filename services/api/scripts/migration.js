...
const mongoosedb = require('@realestatemanagement/common/models/db');
const Realm = require('@realestatemanagement/common/models/realm');
const Lease = require('@realestatemanagement/common/models/lease');
const Property = require('@realestatemanagement/common/models/property');
const Template = require('@realestatemanagement/common/models/template');
// const Tenant = require('@realestatemanagement/common/models/tenant');
// const NewTenant = require('@realestatemanagement/common/models/newtenant');
// const Document = require('@realestatemanagement/common/models/document');
// const Contract = require('@realestatemanagement/common/models/contract');
