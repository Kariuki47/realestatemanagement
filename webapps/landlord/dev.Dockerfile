...
RUN yarn workspaces focus @realestatemanagement/landlord
...
CMD yarn workspace @realestatemanagement/landlord run generateRuntimeEnvFile && \
    yarn workspace @realestatemanagement/landlord run dev -p $PORT
